...
public class Elementos {
	...
	private By abrasuaconta = By.cssSelector("#gatsby-focus-wrapper > header > div > nav > div.sc-tagGq.ghuiff > div > div > span:nth-child(6) > button");
	...
	private By checkbox = By.cssSelector("body > div.sc-fqkvVR.eMDHOt > div.sc-dtBdUo.eMbyIA > div > form > div.sc-bXCLTC.bVusLg > label");
	private By btncontinuar = By.cssSelector("body > div.sc-fqkvVR.eMDHOt > div.sc-dtBdUo.eMbyIA > div > form > button");
